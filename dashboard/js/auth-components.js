/**
 * ==========================================================================
 * Kreditdot GLOBAL UNIFIED AUTHENTICATION INTERACTIVE PRESET WINDOW NODES
 * ==========================================================================
 */
    ...
    async promptPin(titleText = "Configure Secure PIN", subtitleText = "Create a new 4-digit card security signature code") {
        ...
        return Swal.fire({
            ...
            html: `
                ...
                <div class="kreditdot-pin-dots" style="display: flex; justify-content: center; gap: 16px; margin-bottom: 25px;">
                ...
                <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px; max-width: 240px; margin: 0 auto; justify-items: center;">
                    ${[1, 2, 3, 4, 5, 6, 7, 8, 9].map(num => `
                        <button type="button" class="kreditdot-key" data-val="${num}" style="width: 60px; height: 60px; border-radius: 50%; border: 1px solid rgba(255,255,255,0.05); background: #16161a; font-size: 22px; font-weight: 600; color: #fff; cursor: pointer; display: flex; align-items: center; justify-content: center; outline: none; transition: background 0.1s; touch-action: manipulation;">${num}</button>
                    `).join('')}
                    <button type="button" class="kreditdot-action-key" id="create-clear-btn" style="width: 60px; height: 60px; font-size: 13px; font-weight: 600; color: rgba(255,255,255,0.4); background: transparent; border: none; cursor: pointer; outline: none;">Clear</button>
                    <button type="button" class="kreditdot-key" data-val="0" style="width: 60px; height: 60px; border-radius: 50%; border: 1px solid rgba(255,255,255,0.05); background: #16161a; font-size: 22px; font-weight: 600; color: #fff; cursor: pointer; display: flex; align-items: center; justify-content: center; outline: none; transition: background 0.1s; touch-action: manipulation;">0</button>
                    <button type="button" class="kreditdot-action-key" id="create-delete-btn" style="width: 60px; height: 60px; font-size: 13px; font-weight: 600; color: rgba(255,255,255,0.4); background: transparent; border: none; cursor: pointer; outline: none;">Delete</button>
                </div>
            `,
            ...
            didOpen: () => {
                ...
                const keys = popup.querySelectorAll('.kreditdot-key');
        ...
        return new Promise((resolve) => {
            Swal.fire({
                ...
                html: `
                    ...
                    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px; max-width: 240px; margin: 0 auto; justify-items: center;">
                        ${[1, 2, 3, 4, 5, 6, 7, 8, 9].map(num => `
                            <button type="button" class="kreditdot-auth-key" data-val="${num}" style="width: 60px; height: 60px; border-radius: 50%; border: 1px solid rgba(255,255,255,0.05); background: #16161a; font-size: 22px; font-weight: 600; color: #fff; cursor: pointer; display: flex; align-items: center; justify-content: center; outline: none; transition: background 0.1s; touch-action: manipulation;">${num}</button>
                        `).join('')}
                        <button type="button" class="kreditdot-action-key" id="auth-clear-btn" style="width: 60px; height: 60px; font-size: 13px; font-weight: 600; color: rgba(255,255,255,0.4); background: transparent; border: none; cursor: pointer; outline: none;">Clear</button>
                        <button type="button" class="kreditdot-auth-key" data-val="0" style="width: 60px; height: 60px; border-radius: 50%; border: 1px solid rgba(255,255,255,0.05); background: #16161a; font-size: 22px; font-weight: 600; color: #fff; cursor: pointer; display: flex; align-items: center; justify-content: center; outline: none; transition: background 0.1s; touch-action: manipulation;">0</button>
                        <button type="button" class="kreditdot-action-key" id="auth-delete-btn" style="width: 60px; height: 60px; font-size: 13px; font-weight: 600; color: rgba(255,255,255,0.4); background: transparent; border: none; cursor: pointer; outline: none;">Delete</button>
                    </div>
                `,
                showConfirmButton: false,
                showCancelButton: true,
                ...
                didOpen: () => {
                    const popup = Swal.getPopup();
                    const keys = popup.querySelectorAll('.kreditdot-auth-key');
