/**
 * ==========================================================================
 * Kreditdot LIVECHAT DESKTOP & MOBILE SIDEBAR CONTROLLER ENGINE (USER SIDE)
 * ==========================================================================
 */
document.addEventListener("DOMContentLoaded", () => {
            ...
            <div id="liveChatSidebar" class="live-chat-sidebar">
                ...
                <div id="chatSidebarBody" class="chat-sidebar-body">
                    <div class="msg-wrapper msg-support-wrap">
                        <div class="msg-bubble msg-support-bubble">Welcome to KreditDot Live Assistance! Type your text query below or attach an image file directly. How can we serve your portfolio updates?</div>
                    </div>
                </div>
    ...
    const renderDatabaseChatHistory = (messages) => {
        chatBody.innerHTML = `
            <div class="msg-wrapper msg-support-wrap">
                <div class="msg-bubble msg-support-bubble" style="white-space: pre-wrap; word-break: break-word;">Welcome to KreditDot Live Assistance! Type your text query below or attach an image file directly. How can we serve your portfolio updates?</div>
            </div>
        `;
